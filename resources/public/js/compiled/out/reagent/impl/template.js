...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22299__auto__,writer__22300__auto__,opt__22301__auto__){
return cljs.core._write.call(null,writer__22300__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21693__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21693__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21693__auto__)){
return or__21693__auto__;
} else {
...
var G__23390 = o;
(G__23390[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__23392__i < G__23392__a.length) {G__23392__a[G__23392__i] = arguments[G__23392__i + 0]; ++G__23392__i;}
  args = new cljs.core.IndexedSeq(G__23392__a,0);
} 
...
var old_23394 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23394))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23394)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21681__auto__ = (node === document.activeElement);
if(and__21681__auto__){
var and__21681__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__21681__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23397 = jsprops;
(G__23397["defaultValue"] = value);

(G__23397["onChange"] = ((function (G__23397,v,value,on_change){
return (function (p1__23395_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23395_SHARP_);
});})(G__23397,v,value,on_change))
);
...
var vec__23399 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23399,(0),null);
var id = cljs.core.nth.call(null,vec__23399,(1),null);
var class$ = cljs.core.nth.call(null,vec__23399,(2),null);
...
var temp__4659__auto__ = (function (){var G__23403 = cljs.core.meta.call(null,v);
if((G__23403 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23403);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23405_23406 = v;
var G__23405_23407__$1 = (((G__23405_23406 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23405_23406));
if((G__23405_23407__$1 == null)){
} else {
(jsprops["key"] = G__23405_23407__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__23410 = cljs.core.meta.call(null,argv);
if((G__23410 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23410);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__23411 = (((jsprops == null))?{}:jsprops);
(G__23411["key"] = key);
...
var G__23412 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23412;
continue;
}
} else {
...
var n__22608__auto___23413 = a.length;
var i_23414 = (0);
while(true){
if((i_23414 < n__22608__auto___23413)){
(a[i_23414] = reagent.impl.template.as_element.call(null,(a[i_23414])));
...
var a = cljs.core.into_array.call(null,s);
var n__22608__auto___23416 = a.length;
var i_23417 = (0);
while(true){
if((i_23417 < n__22608__auto___23416)){
var val_23418 = (a[i_23417]);
if((cljs.core.vector_QMARK_.call(null,val_23418)) && ((reagent.impl.template.key_from_vec.call(null,val_23418) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23417] = reagent.impl.template.as_element.call(null,val_23418));
...
if(cljs.core.truth_((function (){var and__21681__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21681__auto__){
return (ctx["no-key"]);
} else {
return and__21681__auto__;
...
var G__23421 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23421) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23421){
...
//# sourceMappingURL=template.js.map?rel=1469132186032