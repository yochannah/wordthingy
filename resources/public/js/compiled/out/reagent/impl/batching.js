...
var or__21693__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21693__auto__)){
return or__21693__auto__;
} else {
var or__21693__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21693__auto____$1)){
return or__21693__auto____$1;
} else {
var or__21693__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21693__auto____$2)){
return or__21693__auto____$2;
} else {
var or__21693__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21693__auto____$3)){
return or__21693__auto____$3;
} else {
...
var c_23326 = (a[i]);
if(cljs.core.truth_((c_23326["cljsIsDirty"]))){
(c_23326["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22299__auto__,writer__22300__auto__,opt__22301__auto__){
return cljs.core._write.call(null,writer__22300__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__23330 = c;
var G__23330__$1 = (((G__23330 == null))?null:(G__23330["props"]));
if((G__23330__$1 == null)){
return null;
} else {
return (G__23330__$1["argv"]);
}
});
...
var G__23332_23333 = (c["cljsRatom"]);
if((G__23332_23333 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__23332_23333);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1469132185636