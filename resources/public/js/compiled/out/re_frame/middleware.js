...
while (G__23668__i < G__23668__a.length) {G__23668__a[G__23668__i] = arguments[G__23668__i + 0]; ++G__23668__i;}
  args = new cljs.core.IndexedSeq(G__23668__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__23669){
var args = cljs.core.seq(arglist__23669);
...
return cljs.core.get_in.call(null,new_db,p1__23670_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__23671_SHARP_){
return cljs.core.get_in.call(null,db,p1__23671_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__23672__i = 0, G__23672__a = new Array(arguments.length -  2);
while (G__23672__i < G__23672__a.length) {G__23672__a[G__23672__i] = arguments[G__23672__i + 2]; ++G__23672__i;}
  in_paths = new cljs.core.IndexedSeq(G__23672__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__23673){
var f = cljs.core.first(arglist__23673);
arglist__23673 = cljs.core.next(arglist__23673);
var out_path = cljs.core.first(arglist__23673);
var in_paths = cljs.core.rest(arglist__23673);
...
//# sourceMappingURL=middleware.js.map?rel=1469132186874